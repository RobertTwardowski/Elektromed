...
const handleNav = () =>{
    ...
    barsIco.classList.toggle('hidden')
    xIco.classList.toggle('hidden')
}
//Gallery
const right = () => {
...
const ValidateEmail = (email) => {
  ...
  input.forEach(inputs =>{
    ...
    if(count == 3){
        formFinish.textContent = "Dziękujemy za wypełnienie formularza. Skontaktujemy się jak najszybciej."
